...
const BASE_SYSTEM_PROMPT = [
  ...
  '',
  // Personality from SOUL.md: have opinions, one recognizable face and tone.
  'PERSONALITY:',
  ...
  '',
  // Boundaries from SOUL.md: earn trust through competence and remember you are a guest.
  'BOUNDARIES:',
