...
export const buildArchivePolicyEmbed = () => ({
  ...
  fields: [
    {
      name: '무엇을 보존하나요?',
      value: '서버 개설 이후 Discord API에서 현재 조회 가능한 전체 메시지를 끝까지 백필하고, 이후 메시지·수정 이력·첨부를 계속 보존합니다. 아카이브 도입 전에 이미 삭제된 기록은 복원할 수 없으며, 도입 후 Discord에서 삭제된 메시지는 자동 삭제하지 않습니다.',
    },
    {
      name: '서버를 나가면?',
