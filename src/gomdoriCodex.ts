...
export const GOMDORI_CODEX: CodexEntry[] = [
  ...
  },
  {
    ...
    v1: "구현됨(축약). 배정 시 명예 countBonus +1(생존 시 천사팀 +1). 밤 능동 없음.",
  ...
  },
  {
    ...
    v1: "구현됨(축약). 배정 시 self shield +1(밤 살해·처형 1회 무효). 밤 능동 없음.",
  ...
  // ===== 악마 =====
  {
    ...
    v1: "구현됨(축약). demon_kill(처치). 가인 있으면 보호막 1.",
  ...
  },
  {
    ...
    v1: "구현됨(축약). demon_kill(처치) — 봉인/악몽 지연/일식 미반영.",
  ...
  },
  {
    ...
    v1: "구현됨(축약). demon_kill(처치) — 빙의/혼/시체 미반영.",
  ...
  },
  {
    ...
    v1: "구현됨(축약). demon_kill(처치) — 변신/히든/배후 미반영.",
