...
export const GOMDORI_CODEX: CodexEntry[] = [
  ...
  },
  {
    ...
    abilities: [
      ...
      { kind: "능력", name: "디저트 선물(쿠키)", text: "대상에게 디저트(보호 + 'cookie' 표식)를 부여하고 미즐렛과의 채팅 회로를 엽니다. 쿠키 보유자는 그 밤 탈락해도 그 밤 능력이 발동됩니다(이미 탈락자 직접 지정 절은 후속).", actionType: "mizlet_cookie", status: "live" },
      { kind: "능력", name: "디저트 선물(푸딩)", text: "대상에게 디저트(보호 + 'pudding' 표식)를 부여합니다. 푸딩 보유자가 단일 대상 능력을 쓰면 봉인·지목을 무시하고 발동합니다('무시 불가'). 탈락 시점 밤 조정 절은 후속.", actionType: "mizlet_pudding", status: "live" },
  ...
  },
  {
    ...
    abilities: [
      ...
      { kind: "능력2", name: "건너뛰기", text: "이번 밤에 발동한 다른 모든 효과를 취소합니다(1회성, 최우선). 게임 종료 시까지 건너뛰기를 남긴 채 승리하면 조력자가 패배로 판정됩니다. 원문의 '다음 밤으로 미룸' 진짜 이월은 후속입니다.", actionType: "rosanne_skip", status: "partial" },
    ],
