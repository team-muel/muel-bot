...
export interface CodexAbility {
  ...
  actionType?: string;
  /**
   * 추가 엔진 action_type 배선 — 캐논이 한 카드에 여러 발동(예: 미즐렛 '디저트 선물'의
   * 쿠키/푸딩, 루나 '고요한 적막'의 분기)을 담을 때 사용한다. 카드 수는 캐논 위계를
   * 따르고, 엔진 슬롯 대응(canon-engine-fidelity 고아 슬롯 가드)은 이 목록으로 유지한다.
   */
  actionTypes?: string[];
