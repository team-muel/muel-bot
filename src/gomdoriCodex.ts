...
export const GOMDORI_CODEX: CodexEntry[] = [
  ...
  },
  {
    ...
    v1: "구현됨(축약). police_investigate 재사용 — 악마/천사 판정만 즉시 통지.",
  ...
  },
  {
    ...
    v1: "구현됨(축약). doctor_heal 재사용 — 1_NIGHT 보호.",
  ...
  },
  {
    ...
    v1: "구현됨. mizlet_revive — 디저트 선물(탈락자 부활, SINGLE_DEAD Heal·priority 3).",
  ...
  },
  {
    ...
    v1: "구현됨. 명예 countBonus +1(배정 시) + uno_struggle(투쟁: 대상 소속 카운트 +1, GrantCount).",
  ...
  },
  {
    ...
    v1: "구현됨. self shield +1(배정 시) + arthur_emberblade(잔불 대검: 대상 하루 무적, Protect 1_NIGHT).",
  ...
  },
  {
    ...
    v1: "구현됨. luru_charm — 매료(대상 투표 무력화 + 투표가치 양도, 라운드 한정 Charm).",
  ...
  // ===== 악마 =====
  {
    ...
    v1: "구현됨. demon_kill(처치) + daeakma_brand(메피스토 낙인: Rebrand — 직업 삭제 후 비밀 재배정). 가인 있으면 보호막 1.",
  ...
  },
  {
    ...
    v1: "구현됨. phantom_nightmare(악몽: 아침 탈락·밤 보호 무시) + phantom_seal(봉인, priority 1) + phantom_eclipse(일식: 아침→밤 + 자기 소멸, 1회).",
  ...
  },
  {
    ...
    v1: "구현됨. malen_release(혼령 방출: 처치) + malen_possess(빙의: 그 밤 행동 봉인 + 악마팀 카운트, priority 1). 혼/시체 카운터는 v2.",
  ...
  },
  {
    ...
    v1: "구현됨. besto_hidden(히든 포지션: 처치) + besto_shift(변신: 솔/하베스토 토글·조사 회피, Disguise). 배후는 v2.",
  ...
  },
  {
    ...
    v1: "구현됨. logen_nullify — 네 안에 없는 것(그 밤 능력 봉인, Silence·priority 1).",
