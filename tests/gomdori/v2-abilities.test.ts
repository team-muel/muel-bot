...
assert.match(matchAction, /SELF_ACTIONS = \["phantom_eclipse", "besto_shift", "rainer_summon"\]/, "SELF 행동 집합(+백호 소환)");
...
console.log("Gomdori v2 abilities (봉인/부활/변환/백호) checks passed");
