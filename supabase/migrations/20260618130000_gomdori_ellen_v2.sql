-- 엘런 v2: 해체된 퍼즐(ellen_shatter) 신규 action_type 등록 (2026-06-18).
-- 변경효과(자해 박해)는 ellen_persecute effect 분기 — 스키마 변경 없음.
...
alter table mafia.match_actions
  ...
  check (action_type in (
    ...
    'luna_moonlight','luna_corrupt','logen_nullify','gain_hypocrisy','ellen_persecute','ellen_shatter',
