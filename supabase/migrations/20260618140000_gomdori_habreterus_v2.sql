-- 하브레터스 v2: demon_deduce(악마 측 역추리) 신규 action_type 등록 (2026-06-18).
-- 임종 선언(callingPending/cooldown)은 engine 측 deathHook + 후처리 — 스키마 변경 없음.
...
alter table mafia.match_actions
  ...
  check (action_type in (
    ...
    'malen_release','malen_possess','malen_elusive','besto_hidden','besto_shift','daeakma_brand','daeakma_dominion','demon_deduce',
