-- 루나 v2 분기: luna_dawn(해가 저문다) + luna_moonrise(달이 차오른다) 신규 action_type 등록 (2026-06-18).
-- luna_corrupt 도 canon "1회 제한" — 시멘틱은 maxUses 1 코드만, 스키마 변경 없음.
...
alter table mafia.match_actions
  ...
  check (action_type in (
    ...
    'luna_moonlight','luna_corrupt','luna_dawn','luna_moonrise','logen_nullify','gain_hypocrisy','ellen_persecute',
