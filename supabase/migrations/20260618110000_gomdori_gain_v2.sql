-- 가인 v2: 급습(gain_raid) 신규 action_type 등록 (2026-06-18).
-- 진실을 가리는 암흑 보호막 만료(두 번째 밤 종료 시)는 engine 측 dayCount 게이트만(스키마 변경 없음).
...
alter table mafia.match_actions
  ...
  check (action_type in (
    ...
    'luna_moonlight','luna_corrupt','logen_nullify','gain_hypocrisy','gain_raid','ellen_persecute',
