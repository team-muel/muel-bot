...
--   기존 mizlet_dessert 는 두 변형으로 대체 — action_type 목록에서 제거(쿠키/푸딩으로 분기).
...
alter table mafia.match_actions
  ...
  check (action_type in (
    ...
    'pasua_convert','pasua_faith','mizlet_revive','mizlet_cookie','mizlet_pudding','mizlet_wine','helen_revive','helen_sleep','helen_freebird',
